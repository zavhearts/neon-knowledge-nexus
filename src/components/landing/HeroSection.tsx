...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-cyber-dark">
      ...
      {/* Background circuit animation - optimized and slowed down */}
      <div className="absolute inset-0 bg-cyber-grid opacity-20 animate-circuit-animation-slow"></div>
      
      {/* Glowing orb effects - Adjusted for mobile */}
      <div className="absolute top-1/4 left-1/4 w-32 sm:w-64 h-32 sm:h-64 bg-gradient-radial from-neon-blue/20 to-transparent rounded-full blur-3xl"></div>
      <div className="absolute bottom-1/4 right-1/4 w-40 sm:w-80 h-40 sm:h-80 bg-gradient-radial from-neon-purple/20 to-transparent rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 pt-20 sm:pt-28 pb-12 sm:pb-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          <div className="text-center lg:text-left">
            ...
            {/* Latest Live Class Information - Mobile optimized */}
            <motion.div
              ...
              <div className="glassmorphic rounded-2xl p-1 relative">
                <div className="bg-cyber-darker rounded-xl overflow-hidden">
                  ...
                  <div className="absolute top-4 sm:top-6 right-4 sm:right-6 p-2 sm:p-3 glassmorphic rounded-full shadow-neon-glow animate-float">
                    <Rocket className="text-neon-blue" size={isMobile ? 16 : 24} />
                  </div>
