          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); toast({ title: "Social Media", description: "Social media link coming soon!" }); }}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); toast({ title: "Help Center", description: "Help Center coming soon!" }); }}>
                    Help Center
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); toast({ title: "Contact", description: "Contact page coming soon!" }); }}>
                    Contact Us
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); toast({ title: "Privacy", description: "Privacy Policy coming soon!" }); }}>
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); toast({ title: "Terms", description: "Terms of Service coming soon!" }); }}>
                    Terms of Service
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="flex">
                ...
                />
                <Button 
                  className="bg-neon-blue text-black hover:bg-neon-blue/80 rounded-l-none"
                  onClick={() => toast({ title: "Subscribe", description: "Subscription feature coming soon!" })}
                >
                  Subscribe
                </Button>
              </div>
