          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); alert("Social media link coming soon!"); }}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); alert("Help Center coming soon!"); }}>
                    Help Center
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); alert("Contact page coming soon!"); }}>
                    Contact Us
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); alert("Privacy Policy coming soon!"); }}>
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white/70 hover:text-neon-blue transition-colors" onClick={(e) => { e.preventDefault(); alert("Terms of Service coming soon!"); }}>
                    Terms of Service
                  </a>
                </li>
              </ul>
